...
ComponentRegistrar::register(
	...
	'FishPig_WordPress_DisableWpautop',
	__DIR__
);
...
if (strpos($currentLocation, 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR) !== false) {
	$relativeLocation = 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR . 'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_DisableWpautop';
	...
	if (strpos($currentLocation, $relativeLocation) === false) {
		throw new \Exception(sprintf(
			...
			"FishPig_WordPress_DisableWpautop",
			$relativeLocation,
			'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_DisableWpautop'
		));
	}
}
